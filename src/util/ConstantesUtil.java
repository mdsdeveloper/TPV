...
public class ConstantesUtil {
	...
	public static String listados = "LISTADOS";
	public static final Long idProductosVarios = 1l;
	public static final String preguntaLineaPedido = "¿ Quieres modificar el precio ?";
	public static final String balance = "BALANCE";
	public static final String cierre = "CIERRE CAJA";
	public static final String observaciones = "Observaciones:";
	
	
	public static final String nuevoCliente = "GESTIÓN CLIENTE";
	...
	public static String ok = "/imagenes/ok.png";
	public static String cancel = "/imagenes/cancel.png";
	...
	public static final String iconoExcel = "/imagenes/iconoExcel.png";
	...
	public static final String btnImprimirTicket = "IMPRIMIR TICKET";
	public static final String eliminarTicket = "ELIMINAR TICKET";
	public static final String ticket = "TICKET";
	public static final String devolucion = "DEVOLUCIÓN";
	public static final String devoluciones = "DEVOLUCIONES";
	public static final String dateInicio = "Fecha inicio\n";
	public static final String dateFin = "Fecha fin  \n";
	public static String marcarTodos = "Marcar todos";
	public static String desmarcar = "Desmarcar todos";
	public static String listarExcel = "Listar datos a excel";
	
	public static String estado = "Estado";
	public static String numeroVenta = "Número venta";
	public static String fecha = "Fecha";
	public static String formaPago = "Forma de pago";
	public static String iva = "IVA";
	public static String importe = "Importe";
	public static String totalch = "Total";
	public static String empleadoch = "Empleado";
