...
public class FacturaConCliente extends JDialog implements ActionListener {
	...
	public FacturaConCliente() {
		...
		panelSalir.setBounds(6, 699, 997, 71);
		...
		btnNuevocliente.setBounds(19, 6, 231, 61);
...
//			FormularioPrincipal.btnGestionProd.setEnabled(true);
	...
	//				imprimo factura
					...
					boolean hayFacturaHecha = appService.obtenerfacturasHechaByIdVenta(facturaHecha.getIdVenta());
					if(hayFacturaHecha){
