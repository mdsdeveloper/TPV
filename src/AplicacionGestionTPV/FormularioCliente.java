...
//		setResizable(false);
		...
		panelTitulo.setBounds(10, 6, 668, 66);
		...
		panelSalir.setBounds(10, 695, 668, 71);
	...
	private void construirTabla() {
		...
		panelTabla.setBounds(10, 443, 668, 229);
		panelTabla.setLayout(null);
		
		scrollPane = new JScrollPane();
		scrollPane.setBounds(0, 0, 668, 229);
	...
	private Cliente fillObject(){
		...
		if(validar()){	
			...
			JOptionPane.showMessageDialog(this, "Debes rellenar correctamente los campos antes de crear el cliente.");
		}
		return cliente;
	}
